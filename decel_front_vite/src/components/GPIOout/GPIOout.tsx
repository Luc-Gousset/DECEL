...
const GPIOout: React.FC<GPIO_props> = ({gpio_array, set_gpîo_array}: GPIO_props) => {
  ...
  const handleGpioChange = (val: boolean, ev: MouseEvent | React.SyntheticEvent<MouseEvent | KeyboardEvent, Event>, id: string) => {
    ...
    const socket_msg: SocketInterface = {message_header: "set_gpio", card_id: parseInt(card_id), data: tempGPIOArray};
  ...
  return (
    <div className="flex flex-col items-center bg-gray-300 rounded-lg shadow-md m-5">
